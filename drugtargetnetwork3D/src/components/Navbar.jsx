...
const Tissues = [
  ...
  {
    value: "Haematopoietic and Lymphoid",
    label: "Haematopoietic and Lymphoid",
  },
...
const Compound_class = [
  ...
  {
    value: "Transcription factor inhibitors",
    label: "Transcription factor inhibitors",
  },
  ...
  {
    value: "Epigenetic regulator inhibitors",
    label: "Epigenetic regulator inhibitors",
  },
  {
    value: "Phosphodiesterase inhibitors",
    label: "Phosphodiesterase inhibitors",
  },
  { value: "Enzyme inhibitors", label: "Enzyme inhibitors" },
  { value: "GPCR inhibitors", label: "GPCR inhibitors" },
  {
    value: "Nuclear receptor inhibitors",
    label: "Nuclear receptor inhibitors",
  },
  { value: "Cytochrome inhibitors", label: "Cytochrome inhibitors" },
  {
    value: "Secreted protein inhibitors",
    label: "Secreted protein inhibitors",
  },
  {
    value: "Membrane receptor inhibitors",
    label: "Membrane receptor inhibitors",
  },
  { value: "Phosphatase inhibitors", label: "Phosphatase inhibitors" },
  {
    value: "Structural protein inhibitors",
    label: "Structural protein inhibitors",
  },
...
const Cell_line = [
  ...
  {
    value: "Bronchiolo-Alveolar Lung Carcinoma",
    label: "Bronchiolo-Alveolar Lung Carcinoma",
  },
  {
  ...
  {
    value: "Adult T Acute Lymphoblastic Leukemia",
    label: "Adult T Acute Lymphoblastic Leukemia",
  },
  ...
  {
    value: "Adult Acute Myeloid Leukemia",
    label: "Adult Acute Myeloid Leukemia",
  },
  {
    value: "Pleural Epithelioid Mesothelioma",
    label: "Pleural Epithelioid Mesothelioma",
  },
  {
    value: "Childhood T Acute Lymphoblastic Leukemia",
    label: "Childhood T Acute Lymphoblastic Leukemia",
  },
  {
  ...
  {
    value: "High Grade Ovarian Serous Adenocarcinoma",
    label: "High Grade Ovarian Serous Adenocarcinoma",
  },
  {
    value: "Salivary Gland Squamous Cell Carcinoma",
    label: "Salivary Gland Squamous Cell Carcinoma",
  },
  {
    value: "Childhood B Acute Lymphoblastic Leukemia",
    label: "Childhood B Acute Lymphoblastic Leukemia",
  },
  { value: "Breast Carcinoma", label: "Breast Carcinoma" },
  {
    value: "Epstein-Barr Virus-Related Burkitt's Lymphoma",
    label: "Epstein-Barr Virus-Related Burkitt's Lymphoma",
  },
  {
  ...
  {
    value: "Skin Squamous Cell Carcinoma",
    label: "Skin Squamous Cell Carcinoma",
  },
  {
    value: "Gastric Small Cell Neuroendocrine Carcinoma",
    label: "Gastric Small Cell Neuroendocrine Carcinoma",
  },
  {
    value: "Chronic Eosinophilic Leukemia",
  ...
  {
    value: "Mycosis Fungoides and Sezary Syndrome",
    label: "Mycosis Fungoides and Sezary Syndrome",
  },
  ...
  {
    value: "Gestational Choriocarcinoma",
  ...
  {
    value: "Childhood Acute Myeloid Leukemia with Maturation",
    label: "Childhood Acute Myeloid Leukemia with Maturation",
  },
  ...
  {
    value: "B-Cell Non-Hodgkin's Lymphoma",
    label: "B-Cell Non-Hodgkin's Lymphoma",
  },
  {
  ...
  {
    value: "Adult Acute Monocytic Leukemia",
    label: "Adult Acute Monocytic Leukemia",
  },
  {
    value: "Pleural Biphasic Mesothelioma",
    label: "Pleural Biphasic Mesothelioma",
  },
  {
    value: "Childhood Acute Differentiated Monocytic Leukemia",
    label: "Childhood Acute Differentiated Monocytic Leukemia",
  },
  {
    value: "Adult B Acute Lymphoblastic Leukemia",
    label: "Adult B Acute Lymphoblastic Leukemia",
  },
  {
    value: "Testicular Embryonal Carcinoma",
  ...
  {
    value: "Uterine Corpus Leiomyosarcoma",
    label: "Uterine Corpus Leiomyosarcoma",
  },
  {
    value: "Childhood Precursor T Lymphoblastic Lymphoma",
    label: "Childhood Precursor T Lymphoblastic Lymphoma",
  },
  { value: "Fibrosarcoma", label: "Fibrosarcoma" },
  { value: "Liposarcoma", label: "Liposarcoma" },
  { value: "Vulvar Carcinoma", label: "Vulvar Carcinoma" },
  {
    value: "Undifferentiated Gallbladder Carcinoma",
    label: "Undifferentiated Gallbladder Carcinoma",
  },
  {
    value: "Precursor Lymphoblastic Lymphoma",
    label: "Precursor Lymphoblastic Lymphoma",
  },
  { value: "Follicular Lymphoma", label: "Follicular Lymphoma" },
  { value: "Pancreatic Adenocarcinoma", label: "Pancreatic Adenocarcinoma" },
  {
    value: "Thyroid Gland Anaplastic Carcinoma Squamous Cell",
    label: "Thyroid Gland Anaplastic Carcinoma Squamous Cell",
  },
  { value: "Endometrial Adenocarcinoma", label: "Endometrial Adenocarcinoma" },
  {
    value: "Adrenal Gland Neuroblastoma",
    label: "Adrenal Gland Neuroblastoma",
  },
  {
  ...
  {
    value: "Vulvar Squamous Cell Carcinoma",
  ...
  {
    value: "Adenosquamous Endometrial Carcinoma",
    label: "Adenosquamous Endometrial Carcinoma",
  },
  {
    value: "Natural Killer Cell Lymphoblastic Leukemia or Lymphoma",
    label: "Natural Killer Cell Lymphoblastic Leukemia or Lymphoma",
  },
  {
    value: "Ovarian Clear Cell Adenocarcinoma",
    label: "Ovarian Clear Cell Adenocarcinoma",
  },
  {
    value: "Signet Ring Cell Gastric Adenocarcinoma",
    label: "Signet Ring Cell Gastric Adenocarcinoma",
  },
  {
  ...
  {
    value: "Splenic Marginal Zone B-Cell Lymphoma with Villous",
    label: "Splenic Marginal Zone B-Cell Lymphoma with Villous",
  },
  { value: "Hereditary Spherocytosis", label: "Hereditary Spherocytosis" },
  {
    value: "Gastric Tubular Adenocarcinoma",
    label: "Gastric Tubular Adenocarcinoma",
  },
  { value: "Gallbladder Carcinoma", label: "Gallbladder Carcinoma" },
  { value: "Vulvar Melanoma", label: "Vulvar Melanoma" },
  {
    value: "Cervical Small Cell Carcinoma",
  ...
  {
    value: "Human Papilloma Virus-Related Cervical Squamous Cell Carcinoma",
    label: "Human Papilloma Virus-Related Cervical Squamous Cell Carcinoma",
  },
  { value: "Bronchogenic Carcinoma", label: "Bronchogenic Carcinoma" },
  {
    value: "Squamous Cell Lung Carcinoma",
    label: "Squamous Cell Lung Carcinoma",
  },
  {
    value: "Pleural Sarcomatoid Mesothelioma",
    label: "Pleural Sarcomatoid Mesothelioma",
  },
  {
    value: "Gingival Squamous Cell Carcinoma",
    label: "Gingival Squamous Cell Carcinoma",
  },
  {
    value: "Lung Mucoepidermoid Carcinoma",
  ...
  {
    value: "Ovarian Endometrioid Adenocarcinoma",
    label: "Ovarian Endometrioid Adenocarcinoma",
  },
  {
    value: "Thyroid Gland Anaplastic Carcinoma",
    label: "Thyroid Gland Anaplastic Carcinoma",
  },
  {
    value: "Pharyngeal Squamous Cell Carcinoma",
    label: "Pharyngeal Squamous Cell Carcinoma",
  },
  { value: "Cervical Carcinoma", label: "Cervical Carcinoma" },
  {
    value: "Ovarian Mucinous Adenocarcinoma",
    label: "Ovarian Mucinous Adenocarcinoma",
  },
  {
    value: "Hypopharyngeal Squamous Cell Carcinoma",
    label: "Hypopharyngeal Squamous Cell Carcinoma",
  },
  {
    value: "Endometrial Stromal Sarcoma",
    label: "Endometrial Stromal Sarcoma",
  },
  {
    value: "Squamous Cell Breast Carcinoma Acantholytic Variant",
    label: "Squamous Cell Breast Carcinoma Acantholytic Variant",
  },
  { value: "Hepatocellular Carcinoma", label: "Hepatocellular Carcinoma" },
  {
    value: "Epithelioid Cell Type Gastrointestinal Stromal Tumor",
    label: "Epithelioid Cell Type Gastrointestinal Stromal Tumor",
  },
  {
    value: "Rhabdoid Tumour of the Kidney",
    label: "Rhabdoid Tumour of the Kidney",
  },
  { value: "Askin's Tumor", label: "Askin's Tumor" },
  { value: "Uterine Corpus Sarcoma", label: "Uterine Corpus Sarcoma" },
  {
    value: "Gastric Adenosquamous Carcinoma",
    label: "Gastric Adenosquamous Carcinoma",
  },
  {
    value: "Adenosquamous Lung Carcinoma",
    label: "Adenosquamous Lung Carcinoma",
  },
  {
    value: "Papillary Lung Adenocarcinoma",
    label: "Papillary Lung Adenocarcinoma",
  },
  {
    value: "Ovarian Mixed Germ Cell Tumor",
    label: "Ovarian Mixed Germ Cell Tumor",
  },
  {
  ...
  {
    value: "Renal Pelvis Urothelial Carcinoma",
  ...
  {
    value: "Hereditary Thyroid Gland Medullary Carcinoma",
    label: "Hereditary Thyroid Gland Medullary Carcinoma",
  },
  ...
  {
    value: "Parotid Gland Mucoepidermoid Carcinoma",
    label: "Parotid Gland Mucoepidermoid Carcinoma",
  },
  { value: "Oligodendroglioma", label: "Oligodendroglioma" },
  {
    value: "Laryngeal Squamous Cell Carcinoma",
    label: "Laryngeal Squamous Cell Carcinoma",
  },
  { value: "Ovarian Adenocarcinoma", label: "Ovarian Adenocarcinoma" },
  {
    value: "Pyriform Fossa Squamous Cell Carcinoma",
    label: "Pyriform Fossa Squamous Cell Carcinoma",
  },
  { value: "Cervical Adenocarcinoma", label: "Cervical Adenocarcinoma" },
  {
    value: "Pancreatic Adenosquamous Carcinoma",
    label: "Pancreatic Adenosquamous Carcinoma",
  },
  ...
  {
    value: "Childhood Acute Megakaryoblastic Leukemia",
    label: "Childhood Acute Megakaryoblastic Leukemia",
  },
  {
    value: "Mediastinal Thymic Large B-Cell Cell Lymphoma",
    label: "Mediastinal Thymic Large B-Cell Cell Lymphoma",
  },
  ...
  {
    value: "Mucinous Gastric Adenocarcinoma",
    label: "Mucinous Gastric Adenocarcinoma",
  },
  ...
  {
    value: "Adult Acute Megakaryoblastic Leukemia",
...
const Drug_class_Categories = [
  ...
  {
    value: "Chemically-Induced disorders",
    label: "Chemically-Induced disorders",
  },
